...
#ifndef __GPIO_1125_H_
#define __GPIO_1125_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup GPIO_1125 CHIP: LPC11xx GPIO driver for CHIP_LPC11CXX, CHIP_LPC110X, and CHIP_LPC11XXLV families
...
typedef struct {						/*!< GPIO_PORT Structure */
	...
	__I  uint32_t RESERVED2[8184];		/* Padding added for aligning contiguous GPIO blocks */
} LPC_GPIO_T;
