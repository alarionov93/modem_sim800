/*
 * @brief LPC1125 UART chip driver
 *
 * @note
...
#ifndef __UART_1125_H_
#define __UART_1125_H_
...
/** @defgroup UART_1125 CHIP: LPC1125 UART driver
...
#define UART_IER_MSINT       (1 << 3)	/*!< Modem status interrupt enable - valid for 1125, 17xx/40xx UART1, 18xx/43xx UART1  only */
 ...
 *			order to access the UART Divisor Latches. This function
