/*
 * @brief  LPC1125 A/D conversion driver
 *
 * @note
...
#ifndef __ADC_1125_H_
#define __ADC_1125_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup ADC_1125 CHIP:  LPC1125 A/D conversion driver
 * @ingroup CHIP_1125_Drivers
 * The LPC1125 ADC is different than other LPC11xx ADC peripherals and
 * has a different API than the other LPC11xx ADC driver. The LCP1125 only
 * supports ADC channels 1-8.
 * @{
 */
...
typedef struct {								/*!< ADCn Structure */
	...
	__I  uint32_t DR[9];						/*!< A/D Channel Data Register. This register contains the result of the most recent conversion completed on channel n. */
